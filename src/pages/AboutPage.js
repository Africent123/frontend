...
class HomePage extends React.Component {
  ...
  render() {
    return (
      ...
      <MDBContainer>
        <MDBRow >
          <h4 className="text-center mx-auto pt-5 green-text">About Kannywood TV </h4>
        </MDBRow >

        <MDBCol md="8" className="mx-auto pt-3 pb-5 text-center">
        <MDBRow >
          <div className="offwhite-text"> Kennywood TV is an entertainment platform offering a 
